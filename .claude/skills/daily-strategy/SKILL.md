...
副業戦略（2025年4月〜2026年2月）のロードマップと現在地を照合し、
...
- メルマガ・X・note・オフライン各チャネルのバランス
- 商品リリース・販売状況（テンプレ、パッケージ、AI基礎教材）
...
- しょーさんの副業：生成AI系コンテンツ販売 + AIエージェントテンプレ + サロン「LOOP」
- 活動期間：2025年4月〜2026年2月（10ヶ月）
- 収益目標：売上100万円・利益58万円
- 現フォロワー：3,500人（X）/ メルマガリスト300人（休眠中）
- リソース制約：週数時間（修士課程・就活・事業の並行）
