...
| 考え・意見・気づき・体験 | 直接作成 | 冒頭で結論を断言、口語的で共感を誘う | 個人の考え発信時 |
| 思考・AI論型（AI哲学・AI論） | 直接作成 | 読者の不安と希望を往復させる構成。エン率8〜12%期待 | 月2〜3件・意識的に計画 |
| 1次情報・速報型（AI新モデル・新機能等） | 直接作成 | いち早く発信。数字・実績・スクショ説明推奨 | 速報時 |
| note記事宣伝 | x-note-promo | 記事の核心を短い言葉で表現 | note告知時 |
| カジュアルな告知 | 直接作成 | カジュアルな口調での告知 | ラフな告知時 |
...
- `writing-style-profile.md` で[発信者名]の文体・口調・設計思想を確認（**骨格理解が最優先**）
...
**Step 2: 投稿作成**
- 冒頭で結論を断言する形式で共感投稿を直接作成（口語的なトーン、読者との共感ループを意識）
...
**Step 2: 投稿作成**
- セールス色を薄めたカジュアルな告知投稿を直接作成（ラフな口調・自然な言い回し）
...
- `ai-agent-organization/organization/operations/x-post-creator-X_POST_CREATOR/knowledge/knowhow/writing-style-profile.md` ← **[発信者名]の文体・口調・設計思想。骨格理解に必須**
